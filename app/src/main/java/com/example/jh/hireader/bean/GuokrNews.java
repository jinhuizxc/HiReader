...
public class GuokrNews {
    ...
    public ArrayList<GuokrNews.result> getResult() {
        return result;
    }

    public void setResult(ArrayList<GuokrNews.result> result) {
        this.result = result;
    }
    ...
    public class result {
        ...
        public GuokrNews.source_data getSource_data() {
            return source_data;
        }

        public void setSource_data(GuokrNews.source_data source_data) {
